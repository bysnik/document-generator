...
#### Одиночная генерация
![Одиночная генерация](.images/single.png)

![Одиночная генерация](.images/single-gen.png)

#### Пакетная генерация
![Пакетная генерация](.images/batch.png)

![Пакетная генерация](.images/batch-gen.png)
